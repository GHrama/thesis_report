...
\begin{figure}[htp]
\subtop[Mean of each Group for each Sensor\label{fig:s1}]{\includegraphics[width=0.5\linewidth]{./images/sensors_group_meanQ10}}
\subtop[Variance of each Group for each Sensor\label{fig:s2}]{\includegraphics[width=0.5\linewidth]{./images/sensors_group_varianceQ10}}
...
\begin{figure}[htp]
\subtop[Mean of each Group for each Stakeholder\label{fig:st1}]{\includegraphics[width=0.4\linewidth]{./images/acc_box}}\hspace{1em}
\subtop[Variance of each Group for each Stakeholder\label{fig:st2}]{\includegraphics[width=0.4\linewidth]{./images/loc_box}} \newline
\subtop[Variance of each Group for each Stakeholder\label{fig:st5}]{\includegraphics[width=0.4\linewidth]{./images/prox_box}}\hspace{1em}
\subtop[Variance of each Group for each Stakeholder\label{fig:st2}]{\includegraphics[width=0.4\linewidth]{./images/micro_box}} \newline
\subtop[Variance of each Group for each Stakeholder\label{fig:st5}]{\includegraphics[width=0.4\linewidth]{./images/camera_box}}\hspace{1em}
\subtop[Variance of each Group for each Stakeholder\label{fig:st2}]{\includegraphics[width=0.4\linewidth]{./images/blue_box}}
\caption{Table Schemas}
\label{fig:st3}
\end{figure}
...
\begin{figure}[htp]
\subtop[Mean of each Group for each Stakeholder\label{fig:st1}]{\includegraphics[width=0.55\linewidth]{./images/stakeholders_group_meanQ12}}
\subtop[Variance of each Group for each Stakeholder\label{fig:st2}]{\includegraphics[width=0.55\linewidth]{./images/stakeholders_group_varianceQ12}}
\caption{Table Schemas}
\label{fig:st3}
\end{figure}
...
\begin{figure}[htp]
\subtop[Mean of each Group for each Stakeholder\label{fig:st1}]{\includegraphics[width=0.4\linewidth]{./images/corp_box}}\hspace{1em}
\subtop[Variance of each Group for each Stakeholder\label{fig:st2}]{\includegraphics[width=0.4\linewidth]{./images/ngo_box}} \newline
\subtop[Variance of each Group for each Stakeholder\label{fig:st5}]{\includegraphics[width=0.4\linewidth]{./images/edu_box}}\hspace{1em}
\subtop[Variance of each Group for each Stakeholder\label{fig:st2}]{\includegraphics[width=0.4\linewidth]{./images/gov_box}} 
\caption{Table Schemas}
\label{fig:st3}
\end{figure}
...
\begin{figure}[htp]
\subtop[Mean of each Group for each Context\label{fig:co1}]{\includegraphics[width=0.55\linewidth]{./images/contexts_group_meanQ14}}
\subtop[Variance of each Group for each Context\label{fig:co2}]{\includegraphics[width=0.55\linewidth]{./images/contexts_group_varianceQ14}}
\caption{Table Schemas}
\label{fig:co3}
\end{figure}
...
\subtop[Mean of each Group for each Stakeholder\label{fig:st1}]{\includegraphics[width=0.4\linewidth]{./images/educ_box}}\hspace{1em}
\subtop[Variance of each Group for each Stakeholder\label{fig:st2}]{\includegraphics[width=0.4\linewidth]{./images/ent_box}} \newline
\subtop[Variance of each Group for each Stakeholder\label{fig:st5}]{\includegraphics[width=0.4\linewidth]{./images/env_box}}\hspace{1em}
\subtop[Variance of each Group for each Stakeholder\label{fig:st2}]{\includegraphics[width=0.4\linewidth]{./images/finance_box}} \newline
\subtop[Variance of each Group for each Stakeholder\label{fig:st5}]{\includegraphics[width=0.4\linewidth]{./images/health_box}}\hspace{1em}
\subtop[Variance of each Group for each Stakeholder\label{fig:st2}]{\includegraphics[width=0.4\linewidth]{./images/shopping_box}} 
\caption{Table Schemas}
\label{fig:st3}
\end{figure}

\begin{figure}[htp]
\subtop[Variance of each Group for each Stakeholder\label{fig:st5}]{\includegraphics[width=0.4\linewidth]{./images/social_box}}\hspace{1em}
\subtop[Variance of each Group for each Stakeholder\label{fig:st2}]{\includegraphics[width=0.4\linewidth]{./images/training_box}}\newline
\centering
\subtop[Variance of each Group for each Stakeholder\label{fig:st5}]{\includegraphics[width=0.4\linewidth]{./images/nav_box}}
\caption{Table Schemas}
\label{fig:st3}
\end{figure}
