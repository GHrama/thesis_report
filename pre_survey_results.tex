...
Table \ref{tab:score} shows the average privacy and credit obtained by the users. As seen, privacy is lower than on day one for day two and three and the credit obtained is higher. We can therefore conclude that users are indeed motivated by incentives to share more data for most sensors, stakeholders and contexts.
