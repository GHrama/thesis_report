...
level 1 - \textit{"Not at all concerned"} to level 5 - \textit{"Extremely concerned"}}
\label{fig:st3}
\end{figure}
...
\caption{Given the level of concern of mobile sensor data the probability of the level of importance of sensors, stakeholders and contexts}
\label{fig:pre_h}
\end{figure}
...
\hspace{1em}
\subtop[Actual improvements in rewards and privacy\label{fig:actual_pri}]{\includegraphics[width=0.5\linewidth]{./images/heatmap_all_days_privacyimprovement}}
\caption{Privacy and cost improvements}
\label{fig:st3}
\end{figure}
...
\caption{General user evaluation of the application with levels from level 1 - "Extremely good" to level 5 - "Extremely bad"}
\label{fig:st3}
\end{figure}
