...
\begin{figure}[htp]
\subtop[User evaluation of the comprehension of features\label{fig:pre_8}]{\includegraphics[width=0.45\linewidth]{./images/exit_metrics_useful}}\hspace{1em}
\subtop[User evaluation of the usefulness of features\label{fig:pre_10}]{\includegraphics[width=0.45\linewidth]{./images/exit_metrics_comp}}\newline
\subtop[User evaluation of the privacy\label{fig:pre_12}]{\includegraphics[width=0.45\linewidth]{./images/exit_privacy_questions}}
\hspace{1em}
\subtop[User evaluation of rewards satisfaction\label{fig:pre_10}]{\includegraphics[width=0.45\linewidth]{./images/exit_cost_questions}}\newline
\centering
\subtop[User evaluation of the cost\label{fig:pre_12}]{\includegraphics[width=0.45\linewidth]{./images/exit_cost_questions_14}}
\caption{User evaluation of cost and privacy}
\label{fig:st3}
\end{figure}

\begin{figure}[htp]
\subtop[User experiment interest\label{fig:pre_12}]{\includegraphics[width=0.45\linewidth]{./images/exit_dropout}}
\hspace{1em}
\subtop[User FairDataShare portal visit\label{fig:pre_10}]{\includegraphics[width=0.45\linewidth]{./images/exit_visit_fds}}\newline
\centering
\subtop[User evaluation of the technical problems faced\label{fig:pre_8}]{\includegraphics[width=0.45\linewidth]{./images/exit_tech_probs}}
