...
\hspace{1em}
\subtop[Actual improvements in Cost and Privacy\label{fig:actual_pri}]{\includegraphics[width=0.5\linewidth]{./images/heatmap_all_days_privacyimprovement}}
\caption{Table Schemas}
\label{fig:st3}
\end{figure}
...
\begin{figure}[htp]
\subtop[Importance of stakeholder type for data sharing\label{fig:pre_12}]{\includegraphics[width=0.45\linewidth]{./images/exit_app_quality}}
\hspace{1em}
\subtop[Importance of sensor type for data sharing\label{fig:pre_10}]{\includegraphics[width=0.45\linewidth]{./images/exit_ease_use}}\newline
\centering
\subtop[Level of concern of privacy for mobile sensor data\label{fig:pre_8}]{\includegraphics[width=0.45\linewidth]{./images/exit_eval_features}}
\caption{Figures for mobile privacy concern, importance of sensors, importance of stakeholders and importance of contexts for data sharing}
\label{fig:st3}
\end{figure}

\begin{figure}[htp]
\subtop[Level of concern of privacy for mobile sensor data\label{fig:pre_8}]{\includegraphics[width=0.45\linewidth]{./images/exit_metrics_useful}}\hspace{1em}
\subtop[Importance of sensor type for data sharing\label{fig:pre_10}]{\includegraphics[width=0.45\linewidth]{./images/exit_metrics_comp}}\newline
\subtop[Importance of stakeholder type for data sharing\label{fig:pre_12}]{\includegraphics[width=0.45\linewidth]{./images/exit_privacy_questions}}
\hspace{1em}
\subtop[Importance of sensor type for data sharing\label{fig:pre_10}]{\includegraphics[width=0.45\linewidth]{./images/exit_cost_questions}}\newline
\centering
\subtop[Importance of stakeholder type for data sharing\label{fig:pre_12}]{\includegraphics[width=0.45\linewidth]{./images/exit_cost_questions_14}}
\caption{Figures for mobile privacy concern, importance of sensors, importance of stakeholders and importance of contexts for data sharing}
\label{fig:st3}
\end{figure}

\begin{figure}[htp]
\subtop[Importance of stakeholder type for data sharing\label{fig:pre_12}]{\includegraphics[width=0.45\linewidth]{./images/exit_dropout}}
\hspace{1em}
\subtop[Importance of sensor type for data sharing\label{fig:pre_10}]{\includegraphics[width=0.45\linewidth]{./images/exit_visit_fds}}\newline
\centering
\subtop[Level of concern of privacy for mobile sensor data\label{fig:pre_8}]{\includegraphics[width=0.45\linewidth]{./images/exit_tech_probs}}
\caption{Figures for mobile privacy concern, importance of sensors, importance of stakeholders and importance of contexts for data sharing}
\label{fig:st3}
\end{figure}
