...
\begin{figure}[htp]
  \subtop[Average Intrusion of Sensors Sub-Features\label{fig:pre_se}]{\includegraphics[width=0.45\linewidth]{./images/pre_se}}\hspace{1em}
   \subtop[Average Intrusion of Stakeholders Sub-Features \label{fig:pre_st}]{\includegraphics[width=0.45\linewidth]{./images/pre_st}}\newline
  \centering
  \subtop[Average Intrusion of Contexts Sub-Features\label{fig:pre_co}]{\includegraphics[width=0.45\linewidth]{./images/pre_co}}
  \caption{}
  \label{fig:pre11}
\end{figure}
...
\subsection{Question Structure} \ref{struct}
...
\begin{figure}[htp]
  \subtop[\label{fig:imp_a}]{\includegraphics[width=0.45\linewidth]{./images/improve_layout}}\hspace{1em}
  \subtop[\label{fig:imp_wa}]{\includegraphics[width=0.45\linewidth]{./images/improve}}%
