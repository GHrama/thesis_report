...
%\label{fig:col_ui_2}
%\end{figure}
\includepdf[scale=0.6,pages={-},pagecommand=\section*{Pre-Survey \label{app:pre_survey}}]{pre-survey-pdf}
\includepdf[scale=0.6,pages={-},pagecommand=\section*{Exit-Survey \label{app:exit_survey}}]{exit-survey}
