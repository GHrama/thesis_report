...
\begin{figure}[htp]
  \subtop[Values of the Weight Matrix\label{weight11}]{\includegraphics[width=0.5\linewidth]{./images/weight_1_1}}\hspace{1em}
...
It is concluded that if the users perceive the feature and respective sub-features in an equally intrusive way, then all the
...
\begin{figure}[htp]
  \subtop[Values of the Weight Matrix\label{weight3}]{\includegraphics[width=0.5\linewidth]{./images/weight_3}}\hspace{1em}
...
\begin{figure}[htp]
\subtop[Values of the Weight Matrix\label{weight4}]{\includegraphics[width=0.5\linewidth]{./images/weight_4}}\hspace{1em}
\subtop[Values of the Cost Matrix\label{cost4}]{\includegraphics[width=0.5\linewidth]{./images/cost_4}}
