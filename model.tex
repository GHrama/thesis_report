...
In this scenario we assume that the user has entered the f
...
\begin{figure}[htp]
  \subtop[Values of the Weight Matrix\label{weight2}]{\includegraphics[width=0.5\linewidth]{./images/weight_2}}%
  \subtop[Values of the Cost Matrix \label{cost2}]{\includegraphics[width=0.5\linewidth]{./images/cost_2}}%
...
\begin{table}[h!]
  \centering
  \caption{Categorization for Scenario 5}
  \label{tab:scenario12}
  \begin{tabular}{cccc}
    \toprule
    Feature & Sub-Feature ID = 1 & Sub-Feature ID = 2 & Sub-Feature ID = 3\\
